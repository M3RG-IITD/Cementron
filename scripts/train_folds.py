...
register_coco_instances(name = f"datatrain_{fold}", metadata = {}, 
                        json_file = f"/data/literature_images/cement_coco_train_fold_{fold}.json",
                        image_root = "/data/literature_images")
...
cfg.OUTPUT_DIR = f'./detectron_out/fold_{fold}'
...
# cfg.MODEL.WEIGHTS = f'./detectron_out/fold_{fold}/model_final.pth'
